...
const validateEmailLogin = (emailToCheck) =>emailLoginSchema.validate(emailToCheck);
const validatePasswordLogin = (passwordToCheck) =>passwordLoginSchema.validate(passwordToCheck);
